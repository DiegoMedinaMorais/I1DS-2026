...
switch (mes) {
  ...
  case 2:
  case 3:
    console.log("Você está no primeiro trimestre.");
    break;
  case 4:
  case 5:
  case 6:
    console.log("Você está no segundo trimestre.");
    break;
  case 7:
  case 8:
  case 9:
    console.log("Você está no terceiro trimestre.");
    break;
  case 10:
  case 11:
  case 12:
    console.log("Você está no quarto trimestre.");
    break;

  default:
    console.log("Você não selecionou um mês.");
    break;
}
